    ...
    <section className="relative bg-gradient-to-b from-verde-escuro to-verde-tipografia text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link
                ...
                target="_blank"
              >
                <Button className="bg-roxo hover:bg-roxo/90 text-white px-8 py-6 rounded-lg text-lg">
                  Agende sua Consulta
                </Button>
              </Link>
              <Button
                variant="outline"
                className="bg-transparent border-2 border-bege text-bege hover:bg-bege/10 px-8 py-6 rounded-lg text-lg"
                onClick={() => {
          ...
          >
            <div className="relative w-[280px] h-[280px] md:w-[400px] md:h-[400px] rounded-full overflow-hidden border-4 border-bege/30">
              <Image
                src="/sabrinapage (cópia)/fisioterapeutasabrina.jpeg"
